    ...
    return(
        <section id="A_propos"className='AboutSection'>
            ...
            <p className='AboutSectionP'>
                ...
                <br/>
                Chaque jour, je continues mon apprentissage et je me suis lancée le defi de me former au Back-end. 
                ...
                Mon parcours atypique m'a apporté une perspective unique, alliant sensibilité humaine et expertise technique.<br/>
            </p>
        </section>
    )
}